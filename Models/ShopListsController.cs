...
namespace Borbola_Anamaria_Lab11.Models
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Borbola_Anamaria_Lab11Context _context;

        public ShopListsController(Borbola_Anamaria_Lab11Context context)
        {
            _context = context;
        }
